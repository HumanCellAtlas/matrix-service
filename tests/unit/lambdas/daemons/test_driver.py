...
class TestDriver(unittest.TestCase):
    ...
    def test_run(self, mock_lambda_invoke, mock_dynamo_create_output_table_entry, mock_dynamo_create_state_table_entry):
        ...
        mock_dynamo_create_state_table_entry.assert_called_once_with(self.request_id, num_mappers)
        mock_dynamo_create_output_table_entry.assert_called_once_with(self.request_id)
        expected_calls = [
