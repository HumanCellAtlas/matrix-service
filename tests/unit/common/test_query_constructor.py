...
""")
    ...
    def test_filter_conversion(self):
        ...
        expected_cell_query = ("""
UNLOAD($$SELECT cell.cellkey, cell.cell_suspension_id, cell.genes_detected, cell.file_uuid, cell.file_version, specimen.*, library_preparation.*, project.*, analysis.*"""  # noqa: E501
"""
FROM cell
  LEFT OUTER JOIN specimen on (cell.specimenkey = specimen.specimenkey)
  LEFT OUTER JOIN library_preparation on (cell.librarykey = library_preparation.librarykey)
