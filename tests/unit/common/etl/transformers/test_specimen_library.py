...
class TestSpecimenLibraryTransformer(unittest.TestCase):
    ...
    def test_parse_from_metadatas(self, mock_get):
        ...
        self.assertTrue("80bd863b-d92c-4c5f-98b6-4c32d7b2e806|138c5ad0-17e9-4ab1-b1ca-41b19455f859|"
                        "UBERON:0002113|EXAMPLE_ONTOLOGY|"
    ...
    def test_multiple_donors(self, mock_get):
        ...
        specimen_rows = parsed[0][1]
        self.assertEqual(specimen_table, TableName.SPECIMEN)
        self.assertTrue("b952a25e-6a70-4956-abf3-c195bae4c1b6|1399aa16-3fb0-4a04-a8d2-3af7e079ebf3|"
                        "UBERON:0002097|EXAMPLE_ONTOLOGY|"
    ...
    def test_cell_line(self, mock_get):
        ...
        specimen_rows = parsed[0][1]
        self.assertEqual(specimen_table, TableName.SPECIMEN)
        self.assertTrue("20156407-a6f8-447e-a21e-dbbf66a58043|e24f10c2-e21d-44c4-9450-46029c443941|"
                        "UBERON:0002390|EXAMPLE_ONTOLOGY|"
    ...
    def test_multiple_specimen_use(self, mock_get):
        ...
        self.assertTrue("d6a518a8-0c5d-4cb0-aed5-68f3455c2bda|2b7adb0a-82a4-4319-80d1-4a73d879dec1|"
